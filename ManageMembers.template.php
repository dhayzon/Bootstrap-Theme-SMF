						...
						<div class="msearch_details floatleft">
							<dl class="settings right">
								<dt class="righttext">
									...
									<select class="form-control" name="types[mem_id]">
										<option value="--">&lt;</option>
										<option value="-">&lt;=</option>
								...
								<dt class="righttext">
									...
									<select class="form-control" name="types[age]">
										<option value="--">&lt;</option>
										<option value="-">&lt;=</option>
										<option value="=" selected="selected">=</option>
										<option value="+">&gt;=</option>
								...
								<dt class="righttext">
									...
									<select class="form-control" name="types[posts]">
										<option value="--">&lt;</option>
										<option value="-">&lt;=</option>
										<option value="=" selected="selected">=</option>
										<option value="+">&gt;=</option>
								...
								<dt class="righttext">
									...
									<select class="form-control" name="types[reg_date]">
										<option value="--">&lt;</option>
										<option value="-">&lt;=</option>
										<option value="=" selected="selected">=</option>
										<option value="+">&gt;=</option>
								...
								<dt class="righttext">
									...
									<select class="form-control" name="types[last_online]">
										<option value="--">&lt;</option>
										<option value="-">&lt;=</option>
										<option value="=" selected="selected">=</option>
										<option value="+">&gt;=</option>
		...
		<form action="', $scripturl, '?action=admin;area=viewmembers" method="post" accept-charset="', $context['character_set'], '" name="postFormOutstanding" id="postFormOutstanding" onsubmit="return onOutstandingSubmit();">
			...
			<div class="panel-body">
				...
				<div class="content">
					...
					<input type="submit" value="', $txt['admin_browse_outstanding_go'], '" class="btn btn-default" />
