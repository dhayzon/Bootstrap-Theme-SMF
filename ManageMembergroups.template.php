...
function template_new_group()
{
	...
	if (!$context['post_group'] || !empty($modSettings['permission_enable_postgroups']))
	{
		echo '
						...
						<dd>
							<fieldset id="permission_base">
								...
								<select class="form-control" name="inheritperm" id="inheritperm_select" onclick="document.getElementById(\'perm_type_inherit\').checked = true;">
		...
		echo '
								...
								<select class="form-control" name="copyperm" id="copyperm_select" onclick="document.getElementById(\'perm_type_copy\').checked = true;">
									<option value="-1">', $txt['membergroups_guests'], '</option>
									<option value="0" selected="selected">', $txt['membergroups_members'], '</option>';
		foreach ($context['groups'] as $group)
			echo '
		...
		echo '
								...
								<select class="form-control" name="level" id="level_select" onclick="document.getElementById(\'perm_type_predefined\').checked = true;">
...
function template_edit_group()
{
	...
	if ($context['group']['id'] != 3 && $context['group']['id'] != 4)
		echo '
						...
						<dd>
							<select class="form-control" name="group_hidden" id="group_hidden_input" onchange="if (this.value == 2 &amp;&amp; !confirm(\'', $txt['membergroups_edit_hidden_warning'], '\')) this.value = 0;">
	...
	if ($context['group']['id'] > 1 && $context['group']['id'] != 3)
	{
		echo '
						...
						<dd>
							<select class="form-control" name="group_inherit" id="group_inherit_input">
	...
	echo '
					...
					<div class="righttext">
						<input type="submit" name="submit" value="', $txt['membergroups_edit_save'], '" class="btn btn-default" />', $context['group']['allow_delete'] ? '
...
function template_group_request_reason()
{
	...
	echo '
					...
					<input type="submit" name="go" value="', $txt['mc_groupr_submit'], '" class="btn btn-default" />
