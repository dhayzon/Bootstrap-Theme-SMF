...
function template_main()
{
	...
	if (!empty($context['boards']) && (!empty($options['show_children']) || $context['start'] == 0))
	{
	 echo '
		<div class="panel panel-default">
			<h3 class="panel-body heading-h">', $txt['parent_boards'], '</h3>
		</div>
	...
	<div id="messageindex">
		...
		{
			echo '
				<li class="list-group-item whos_viewing">
		...
		foreach ($context['topics'] as $topic)
		{
			...
			echo '
				<li class="list-group-item"><div class="row">
					...
					<div  class="col-xs-12 col-sm-7 subject ', $alternate_class, '">
			...
			echo '
					...
					<div  class="col-xs-12 col-sm-2 ', $color_class, '">
						', $topic['replies'], ' ', $txt['replies'], '
						<br />
						', $topic['views'], ' ', $txt['views'], '
					</div>
					<div  class="col-xs-12 col-sm-2 ', $alternate_class, '">
			...
			{
				echo '
					<span class="moderation pull-right ', $color_class, '" >';
		 ...
		 if (!empty($context['can_quick_mod']) && $options['display_quick_mod'] == 1 && !empty($context['topics']))
		 {
			...
			echo ' <span class="input-group-btn">
						<input type="submit" value="', $txt['quick_mod_go'], '" onclick="return document.forms.quickModForm.qaction.value != \'\' &amp;&amp; confirm(\'', $txt['quickmod_confirm'], '\');" class="btn btn-default" />
					</span></div>
				</div>';
		 }
	...
	<div id="topic_icons">
		<div class="row">
			<div class="col-xs-12 col-md-4 pull-right"><div class="input-group" id="message_index_jump_to"></div></div>';

	if (!$context['no_topic_listing'])
		echo '<div class="col-xs-12 panel-body">
			<div class="col-xs-12 col-xs-6">', !empty($modSettings['enableParticipation']) && $context['user']['is_logged'] ? '
			...
			<script type="text/javascript"><!-- // --><![CDATA[
				if (typeof(window.XMLHttpRequest) != "undefined")
					aJumpTo[aJumpTo.length] = new JumpTo({
						...
						sJumpToTemplate: "<span class=\"input-group-addon\" for=\"%select_id%\">', $context['jump_to']['label'], ':<" + "/span> %dropdown_list%",
