...
function template_main()
{
	...
	foreach ($context['categories'] as $category)
	{
		...
		echo '
					...
					<div class="righttext">
						<input type="submit" value="', $txt['mboards_new_board'], '" class="btn btn-default" />
...
function template_modify_category()
{
	...
	if (count($context['category_order']) > 1)
	{
		echo '
						...
						<dd>
							<select class="form-control" name="cat_order">';
	...
	if (isset($context['category']['is_new']))
		echo '
						<input type="submit" name="add" value="', $txt['mboards_add_cat_button'], '" onclick="return !isEmptyText(this.form.cat_name);" tabindex="', $context['tabindex']++, '" class="btn btn-default" />';
	else
		echo '
						<input type="submit" name="edit" value="', $txt['modify'], '" onclick="return !isEmptyText(this.form.cat_name);" tabindex="', $context['tabindex']++, '" class="btn btn-default" />
						<input type="submit" name="delete" value="', $txt['mboards_delete_cat'], '" onclick="return confirm(\'', $txt['catConfirm'], '\');" class="btn btn-default" />';
	echo '
						<input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '" />';
...
function template_confirm_category_delete()
{
			...
			<div class="windowbg">
				...
				<div class="content">
					<p>
						...
						<select class="form-control" name="cat_to" ', count($context['category_order']) == 1 ? 'disabled="disabled"' : '', '>';
	...
	echo '
					...
					<input type="submit" name="delete" value="', $txt['mboards_delete_confirm'], '" class="btn btn-default" />
					<input type="submit" name="cancel" value="', $txt['mboards_delete_cancel'], '" class="btn btn-default" />
...
function template_modify_board()
{
	...
	echo '
						...
						<dd>
							<select class="form-control" name="new_cat" onchange="if (this.form.order) {this.form.order.disabled = this.options[this.selectedIndex].value != 0; this.form.board_order.disabled = this.options[this.selectedIndex].value != 0 || this.form.order.options[this.form.order.selectedIndex].value == \'\';}">';
		foreach ($context['categories'] as $category)
			echo '
	...
	echo '
							<select class="form-control" id="order" name="placement" onchange="this.form.board_order.disabled = this.options[this.selectedIndex].value == \'\';">
	...
	echo '
							<select class="form-control" id="board_order" name="board_order" ', isset($context['board']['is_new']) ? '' : 'disabled="disabled"', '>
								', !isset($context['board']['is_new']) ? '<option value="">(' . $txt['mboards_unchanged'] . ')</option>' : '';
	...
	echo '
					<div id="board_theme_div">
						<dl class="dl-horizontal">
							...
							<dd>
								<select class="form-control" name="boardtheme" id="boardtheme" onchange="refreshOptions();">
	...
	if (isset($context['board']['is_new']))
		echo '
					...
					<input type="submit" name="add" value="', $txt['mboards_new_board'], '" onclick="return !isEmptyText(this.form.board_name);" class="btn btn-default" />';
	else
		echo '
					<input type="submit" name="edit" value="', $txt['modify'], '" onclick="return !isEmptyText(this.form.board_name);" class="btn btn-default" />';
			...
			<div class="windowbg">
				...
				<div class="content">
					<p>
						...
						<select class="form-control" name="board_to" ', empty($context['can_move_children']) ? 'disabled="disabled"' : '', '>';
