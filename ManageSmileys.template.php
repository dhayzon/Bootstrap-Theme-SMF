...
function template_modifyset()
{
	...
	<div id="admincenter">
		...
		{
			echo '
							<select class="form-control" name="smiley_sets_path" id="smiley_sets_path">';
...
function template_modifysmiley()
{
	...
	<div id="admincenter">
			...
			<div class="panel-body">
				...
				<div class="content">
					<dl class="dl-horizontal">
						...
						<dd>
							<img src="', $modSettings['smileys_url'], '/', $modSettings['smiley_sets_default'], '/', $context['current_smiley']['filename'], '" id="preview" alt="" /> (', $txt['smiley_preview_using'], ': <select class="form-control" name="set" onchange="updatePreview();">';
		...
		echo '
			...
			{
				echo '
							<select class="form-control" name="smiley_filename" id="smiley_filename" onchange="updatePreview();">';
			...
			echo '
						...
						<dd>
							<select class="form-control" name="smiley_location" id="smiley_location">
...
function template_addsmiley()
{
				...
				<div class="content">
					...
					<fieldset id="ex_settings">
						<dl class="dl-horizontal">
							...
							<dd>
								', $txt['smiley_preview_using'], ': <select class="form-control" name="set" onchange="updatePreview();selectMethod(\'existing\');">
	...
	{
		echo '
									<select class="form-control" name="smiley_filename" id="smiley_filename" onchange="updatePreview();selectMethod(\'existing\');">';
		foreach ($context['filenames'] as $filename)
			echo '
									<option value="', $filename['id'], '"', $filename['selected'] ? ' selected="selected"' : '', '>', $filename['id'], '</option>';
		echo '
...
function template_editicon()
{
	...
	echo '
						...
						<dd>
							<select class="form-control" name="icon_board" id="icon_board_select">
	...
	echo '
						...
						<dd>
							<select class="form-control" name="icon_location" id="icon_location">
