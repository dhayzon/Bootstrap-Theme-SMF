...
function template_main()
{
	...
	<div id="admincenter">
		<form action="', $scripturl, '?action=admin;area=theme;sa=admin" method="post" accept-charset="', $context['character_set'], '">
			...
			<div class="panel-body">
				<h3>
					<span class="ie6_header floatleft"><a href="', $scripturl, '?action=helpadmin;help=themes" onclick="return reqWin(this.href);" ><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true" data-toggle="tooltip" title="', $txt['help'], '"></span> </a>
	...
	foreach ($context['themes'] as $theme)
		...
		echo '
						...
						<dd>
							<select class="form-control" name="options[theme_guests]" id="theme_guests">';
	...
	echo '
						...
						<dd>
							<select class="form-control" name="theme_reset" id="theme_reset">
	...
	echo '
		...
		<div class="panel-body">
			<h3>
				<span class="ie6_header floatleft"><a href="', $scripturl, '?action=helpadmin;help=latest_themes" onclick="return reqWin(this.href);" ><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true" data-toggle="tooltip" title="', $txt['help'], '"></span> </a> ', $txt['theme_latest'], '</span>
			</h3>
		</div>
		<div class="panel-body">
	...
	if (!$context['can_create_new'])
		...
		<form action="', $scripturl, '?action=admin;area=theme;sa=install" method="post" accept-charset="', $context['character_set'], '" enctype="multipart/form-data" onsubmit="return confirm(\'', $txt['theme_install_new_confirm'], '\');">
			<div class="panel-body">
				<h3>
					<span class="ie6_header floatleft"><a href="', $scripturl, '?action=helpadmin;help=theme_install" onclick="return reqWin(this.href);" ><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true" data-toggle="tooltip" title="', $txt['help'], '"></span> </a> ', $txt['theme_install'], '</span>
				</h3>
			</div>
			<div class="panel-body">
	...
	echo '
						...
						<dd>
							<input type="text" name="theme_dir" id="theme_dir" value="', $context['new_theme_dir'], '" size="40" style="width: 70%;" class="form-control" />
						</dd>';
	...
	if ($context['can_create_new'])
		echo '
						...
						<dd>
							<input type="text" name="copy" id="copy" value="', $context['new_theme_name'], '" size="40" class="form-control" />
						</dd>';
		...
		echo '
			<div class="panel panel-danger">
				<h3 class="panel-heading">
					<span class="pull-left"><strong><a href="', $scripturl, '?action=admin;area=theme;th=', $theme['id'], ';', $context['session_var'], '=', $context['session_id'], ';sa=settings">', $theme['name'], '</a></strong>', !empty($theme['version']) ? ' <em>(' . $theme['version'] . ')</em>' : '', '</span>';

			// You *cannot* delete the default theme. It's important!
			if ($theme['id'] != 1)
				echo '
					<span class="pull-right"><a href="', $scripturl, '?action=admin;area=theme;sa=remove;th=', $theme['id'], ';', $context['session_var'], '=', $context['session_id'], '" onclick="return confirm(\'', $txt['theme_remove_confirm'], '\');"><img src="', $settings['images_url'], '/icons/delete.gif" alt="', $txt['theme_remove'], '" title="', $txt['theme_remove'], '" /></a></span>';
			...
			<div class="panel-body">
				...
				<div class="content">
					<dl class="dl-horizontal">
						...
						<dd>
							<input type="text" name="reset_dir" id="reset_dir" value="', $context['reset_dir'], '" size="40" style="width: 80%;" class="form-control" />
						</dd>
						<dt>
							<label for="reset_url">', $txt['themeadmin_list_reset_url'], '</label>:
						</dt>
						<dd>
							<input type="text" name="reset_url" id="reset_url" value="', $context['reset_url'], '" size="40" style="width: 80%;" class="form-control" />
						</dd>
					</dl>
...
function template_set_options()
{
	...
	<div id="admincenter">
		<form action="', $scripturl, '?action=admin;area=theme;th=', $context['theme_settings']['theme_id'], ';sa=reset" method="post" accept-charset="', $context['character_set'], '">
			...
			<div class="panel-body">
				<h3>', $txt['theme_options_title'], ' - ', $context['theme_settings']['name'], '</h3>
			</div>
			<div class="information">
	...
	foreach ($context['options'] as $setting)
	{
		...
		if ($context['theme_options_reset'])
			echo '
							<select class="form-control" name="', !empty($setting['default']) ? 'default_' : '', 'options_master[', $setting['id'], ']" onchange="this.form.options_', $setting['id'], '.disabled = this.selectedIndex != 1;">
		...
		elseif ($setting['type'] == 'list')
		{
			echo '
							...
							<select class="form-control" name="', !empty($setting['default']) ? 'default_' : '', 'options[', $setting['id'], ']" id="options_', $setting['id'], '"', $context['theme_options_reset'] ? ' disabled="disabled"' : '', '>';
			...
			echo '
							&nbsp;<label for="options_', $setting['id'], '">', $setting['label'], '</label>
							<input type="text" name="', !empty($setting['default']) ? 'default_' : '', 'options[', $setting['id'], ']" id="options_', $setting['id'], '" value="', $setting['value'], '"', $setting['type'] == 'number' ? ' size="5"' : '', $context['theme_options_reset'] ? ' disabled="disabled"' : '', ' class="form-control" />';
...
function template_set_settings()
{
	...
	<div id="admincenter">
		<form action="', $scripturl, '?action=admin;area=theme;sa=settings;th=', $context['theme_settings']['theme_id'], '" method="post" accept-charset="', $context['character_set'], '">
			<div class="panel panel-danger">
				<h3 class="panel-heading">
					<span class="ie6_header floatleft"><a href="', $scripturl, '?action=helpadmin;help=theme_settings" onclick="return reqWin(this.href);" ><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true" data-toggle="tooltip" title="', $txt['help'], '"></span> </a> ', $txt['theme_settings'], ' - ', $context['theme_settings']['name'], '</span>
				</h3>
			</div>';
			...
			<div class="panel-body">
				...
				<div class="content">
					<dl class="dl-horizontal">
						...
						<dd>
							<input type="text" id="theme_name" name="options[name]" value="', $context['theme_settings']['name'], '" size="32" class="form-control" />
						</dd>
						<dt>
							<label for="theme_url">', $txt['actual_theme_url'], '</label>
						</dt>
						<dd>
							<input type="text" id="theme_url" name="options[theme_url]" value="', $context['theme_settings']['actual_theme_url'], '" size="50" style="max-width: 100%; width: 50ex;" class="form-control" />
						</dd>
						<dt>
							<label for="images_url">', $txt['actual_images_url'], '</label>
						</dt>
						<dd>
							<input type="text" id="images_url" name="options[images_url]" value="', $context['theme_settings']['actual_images_url'], '" size="50" style="max-width: 100%; width: 50ex;" class="form-control" />
						</dd>
						<dt>
							<label for="theme_dir">', $txt['actual_theme_dir'], '</label>
						</dt>
						<dd>
							<input type="text" id="theme_dir" name="options[theme_dir]" value="', $context['theme_settings']['actual_theme_dir'], '" size="50" style="max-width: 100%; width: 50ex;" class="form-control" />
						</dd>
					</dl>
				</div>
			</div>';
	...
	if (!empty($context['theme_variants']))
	{
		echo '
			<div class="panel-body">
				<h3>
					<span class="ie6_header floatleft"><img src="', $settings['images_url'], '/icons/config_sm.gif" alt=""  /> ', $txt['theme_variants'], '</span>
				</h3>
			</div>
			<div class="panel-body">
				...
				<div class="content">
					<dl class="dl-horizontal">
						...
						<dd>
							<select class="form-control" id="variant" name="options[default_variant]" onchange="changeVariant(this.value)">';
	...
	foreach ($context['settings'] as $setting)
	{
		...
		elseif ($setting['type'] == 'list')
		{
			...
			echo '
						...
						<dd>
							<select class="form-control" name="', !empty($setting['default']) ? 'default_' : '', 'options[', $setting['id'], ']" id="', $setting['id'], '">';
		...
		else
		{
			...
			echo '
						...
						<dd>
							<input type="text" name="', !empty($setting['default']) ? 'default_' : '', 'options[', $setting['id'], ']" id="', $setting['id'], '" value="', $setting['value'], '"', $setting['type'] == 'number' ? ' size="5"' : (empty($setting['size']) ? ' size="40"' : ' size="' . $setting['size'] . '"'), ' class="form-control" />
						</dd>';
		}
	}
	...
	foreach ($context['available_themes'] as $theme)
	{
		...
		if (!empty($theme['variants']))
		{
			echo '
					...
					<select class="form-control" id="variant', $theme['id'], '" name="vrt[', $theme['id'], ']" onchange="changeVariant', $theme['id'], '(this.value);">';
			...
			echo '
					...
					<noscript>
						<input type="submit" name="save[', $theme['id'], ']" value="', $txt['save'], '" class="btn btn-default" />
					</noscript>';
		}
...
function template_edit_browse()
{
	...
	<div id="admincenter">
		...
		<thead>
			<tr>
				<th class="lefttext first_th"  width="50%">', $txt['themeadmin_edit_filename'], '</th>
				<th  width="35%">', $txt['themeadmin_edit_modified'], '</th>
				<th  width="15%">', $txt['themeadmin_edit_size'], '</th>
			</tr>
		</thead>
		<tbody>';
...
function template_edit_style()
{
	...
	echo '
					...
					<div class="padding righttext">
						<input type="submit" name="submit" value="', $txt['theme_edit_save'], '"', $context['allow_save'] ? '' : ' disabled="disabled"', ' style="margin-top: 1ex;" class="btn btn-default" />
