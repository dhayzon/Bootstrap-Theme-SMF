...
function template_edit_news()
{
	...
	echo '
			...
			<div class="floatrightpadding">
				<input type="submit" name="save_items" value="', $txt['save'], '" class="btn btn-default" /> <input type="submit" name="delete_selection" value="', $txt['editnews_remove_selected'], '" onclick="return confirm(\'', $txt['editnews_remove_confirm'], '\');" class="btn btn-default" />
			</div>
		...
		<form action="', $scripturl, '?action=admin;area=news;sa=mailingsend" method="post" accept-charset="', $context['character_set'], '" name="autoSubmit" id="autoSubmit">
			...
			<div class="windowbg">
				...
				<div class="content">
					...
					<input type="submit" name="b" value="', $txt['email_continue'], '" class="btn btn-default" />
					<input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '" />
