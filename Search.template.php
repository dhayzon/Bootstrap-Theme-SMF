		...
		if ($context['require_verification'])
			echo '
				<div class="verification>
					...
					<input id="submit" type="submit" name="submit" value="' . $txt['search'] . '" class="btn btn-default" />
				</div>';
	...
	echo '
		...
		if (!empty($options['display_quick_mod']) && $options['display_quick_mod'] == 1 && !empty($context['topics']))
		{
			...
			echo '
					...
					<input type="submit" style="font-size: 0.8em;" value="', $txt['quick_mod_go'], '" onclick="return this.form.qaction.value != \'\' &amp;&amp; confirm(\'', $txt['quickmod_confirm'], '\');" class="btn btn-default" />
				</div>
				<br class="clear" />
			</div>';
		}
