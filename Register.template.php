...
function template_registration_agreement()
{
	...
	if ($context['show_coppa'])
		echo '
				<input type="submit" name="accept_agreement" value="', $context['coppa_agree_above'], '" class="btn btn-default" /><br /><br />
				<input type="submit" name="accept_agreement_coppa" value="', $context['coppa_agree_below'], '" class="btn btn-default" />';
	else
		echo '
				<input type="submit" name="accept_agreement" value="', $txt['agreement_agree'], '" class="btn btn-default" />';
...
function template_registration_form()
{
	...
	if (!empty($context['profile_fields']))
	{
		...
		foreach ($context['profile_fields'] as $key => $field)
		{
			...
			else
			{
				...
				{
					echo '
							<select class="form-control" name="', $key, '" id="', $key, '" tabindex="', $context['tabindex']++, '">';
	...
	echo '
			<div id="confirm_buttons">
				<input type="submit" name="regSubmit" value="', $txt['register'], '" tabindex="', $context['tabindex']++, '" class="btn btn-default" />
			</div>
...
function template_admin_register()
{
	...
	if (!empty($context['member_groups']))
	{
		echo '
					...
					<dd>
						<select class="form-control" name="group" id="group_select" tabindex="', $context['tabindex']++, '">';
...
function template_edit_agreement()
{
	...
	if (count($context['editable_agreements']) > 1)
	{
		echo '
				<div class="information">
					<form action="', $scripturl, '?action=admin;area=regcenter" id="change_reg" method="post" accept-charset="', $context['character_set'], '" style="display: inline;">
						...
						<select class="form-control" name="agree_lang" onchange="document.getElementById(\'change_reg\').submit();" tabindex="', $context['tabindex']++, '">';
		...
		echo '
						...
						<div class="righttext">
							...
							<input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '" />
							<input type="submit" name="change" value="', $txt['admin_agreement_select_language_change'], '" tabindex="', $context['tabindex']++, '" class="btn btn-default" />
						</div>
					</form>
				</div>';
	}
	...
	echo '
					...
					<div class="righttext">
						<input type="submit" value="', $txt['save'], '" tabindex="', $context['tabindex']++, '" class="btn btn-default" />
