...
function template_edit_holiday()
{
	...
	echo '
							...
							', $txt['calendar_day'], '&nbsp;
							<select class="form-control" name="day" id="day" onchange="generateDays();">';
	...
	if ($context['is_new'])
		echo '
					<input type="submit" value="', $txt['holidays_button_add'], '" class="btn btn-default" />';
	else
		echo '
					<input type="submit" name="edit" value="', $txt['holidays_button_edit'], '" class="btn btn-default" />
					<input type="submit" name="delete" value="', $txt['holidays_button_remove'], '" class="btn btn-default" />
