	...
	if (!$context['ftp_needed'] && (!empty($context['actions']) || !empty($context['database_changes'])))
	{
		echo '
			<div class="righttext padding">
				<input type="submit" value="', $context['uninstalling'] ? $txt['package_uninstall_now'] : $txt['package_install_now'], '" onclick="return ', !empty($context['has_failure']) ? '(submitThisOnce(this) &amp;&amp; confirm(\'' . ($context['uninstalling'] ? $txt['package_will_fail_popup_uninstall'] : $txt['package_will_fail_popup']) . '\'))' : 'submitThisOnce(this)', ';" class="btn btn-default" />
			</div>';
	}
		...
		<div class="windowbg">
			...
			<div class="content">
				...
				<form action="', $scripturl, '?action=admin;area=packages;get" method="post" accept-charset="', $context['character_set'], '">
					...
					<div class="righttext">
						<input type="submit" value="', $txt['package_proceed'], '" class="btn btn-default" />
					</div>
				</form>
			</div>
			<span class="botslice"><span></span></span>
	...
	echo '
				...
				<fieldset>
					...
					<form action="' . $scripturl . '?action=admin;area=packages;get;sa=add" method="post" accept-charset="', $context['character_set'], '">
						...
						<div class="righttext">
							<input type="submit" value="' . $txt['add_server'] . '" class="btn btn-default" />
				...
				<fieldset>
					...
					<form action="', $scripturl, '?action=admin;area=packages;get;sa=download;byurl;', $context['session_var'], '=', $context['session_id'], '" method="post" accept-charset="', $context['character_set'], '">
						...
						<div class="righttext">
							<input type="submit" value="', $txt['download'], '" class="btn btn-default" />
						</div>
					</form>
				</fieldset>
			</div>
		...
		<div class="windowbg">
			...
			<div class="content">
				<form action="' . $scripturl . '?action=admin;area=packages;get;sa=upload" method="post" accept-charset="', $context['character_set'], '" enctype="multipart/form-data" style="margin-bottom: 0;">
					...
					<div class="righttext">
						<input type="submit" value="' . $txt['package_upload'] . '" class="btn btn-default" />
						<input type="hidden" name="' . $context['session_var'] . '" value="' . $context['session_id'] . '" />
					</div>
				</form>
			</div>
				...
				<fieldset>
					<dl>
						...
						<dt>
							...
							<select class="form-control" name="predefined" onchange="document.getElementById(\'method_predefined\').checked = \'checked\';">
