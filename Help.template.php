...
<html xmlns="http://www.w3.org/1999/xhtml"', $context['right_to_left'] ? ' dir="rtl"' : '', '>
			...
			<div class="roundframe">
				<div class="innerframe">
					...
					<div class="padding">
						...
						<input type="text" name="search" id="search" value="', isset($context['last_search']) ? $context['last_search'] : '', '" style="margin-top: 4px; width: 96%;" class="form-control" /><br />
	...
	echo '
						<div class="padding righttext">
							...
							<input type="button" value="', $txt['find_close'], '" onclick="window.close();" class="btn btn-default" />
						</div>
					</div>
				</div>
			</div>
