...
function template_main()
{
	...
	echo '
					...
					<input type="submit" class="btn btn-default" value="', $txt['view'], '" />';
...
function template_event_post()
{
	...
	if ($context['event']['new'])
	{
		echo '
								...
								<li>
									...
									<select class="form-control" id="board" name="board" onchange="this.form.submit();">';
	...
	echo '
					<div class="righttext">
						<input type="submit" value="', empty($context['event']['new']) ? $txt['save'] : $txt['post'], '" class="btn btn-default" />';
	// Delete button?
	if (empty($context['event']['new']))
		echo '
						<input type="submit" name="deleteevent" value="', $txt['event_delete'], '" onclick="return confirm(\'', $txt['calendar_confirm_delete'], '\');" class="btn btn-default" />';
