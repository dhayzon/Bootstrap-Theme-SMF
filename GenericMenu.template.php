...
function template_generic_menu_dropdown_above()
{
	...
	echo '
<div id="admin_menu">
	<ul class="nav nav-tabs" id="dropdown_menu_', $context['cur_menu_id'], '">';
	...
	foreach ($menu_context['sections'] as $section)
	{
		...
		{
			echo '
			<li role="presentation" class="active"><a  href="#" data-toggle="dropdown" ><span>', $section['title'] , ' <span class="caret"></span></span></a>
				<ul class="dropdown-menu multi-level" role="menu">';
		}
		else
			echo '
			<li role="presentation"><a href="#" data-toggle="dropdown"><span>', $section['title'] , ' <span class="caret"></span></span></a>
				<ul class="dropdown-menu multi-level" role="menu">';
